...
TEST(BasicBlock, flow)
{
    ...
    EXPECT_EQ(b2.get_cond(), nullptr);
    EXPECT_EQ(b0.edges_inn, 0);
    EXPECT_EQ(b0.edges_out, 1);
    EXPECT_EQ(b1.edges_inn, 2);
    EXPECT_EQ(b1.edges_out, 2);
    EXPECT_EQ(b2.edges_inn, 2);
    EXPECT_EQ(b2.edges_out, 1);
    EXPECT_EQ(b3.edges_inn, 1);
    EXPECT_EQ(b3.edges_out, 1);
}
